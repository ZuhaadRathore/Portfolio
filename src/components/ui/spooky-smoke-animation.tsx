...
void main(){
  ...
  float rawAlpha=smoothstep(0.44,1.05,density);
  float bandCount=3.0;
  ...
  float cornerRadius=mix(0.4,1.6,u_reveal);
  float cornerPower=mix(0.8,2.4,u_reveal);
  ...
  O=vec4(u_color,clamp(alpha*2.5,0.0,1.0));
}`
